...
import pt.ulisboa.tecnico.cnv.aws.DynamoDB;
...
public abstract class BaseCompressingHandler implements HttpHandler, RequestHandler<Map<String, String>, String> {
    ...
    public void handle(HttpExchange t) throws IOException {
        ...
        if (t.getRequestMethod().equalsIgnoreCase("OPTIONS")) {
            ...
            pt.ulisboa.tecnico.cnv.javassist.tools.ICount.saveFields("compression - Image Size/Target Format/Compression Factor: " + resultSplits[1].length() + "/" + targetFormat + "/" + compressionFactor);
