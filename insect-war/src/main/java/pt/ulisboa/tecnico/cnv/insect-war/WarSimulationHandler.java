...
public class WarSimulationHandler implements HttpHandler, RequestHandler<Map<String, String>, String> {
    ...
    public void handle(HttpExchange he) throws IOException {
        ...
        pt.ulisboa.tecnico.cnv.javassist.tools.ICount.saveFields(Integer.parseInt(parameters.get("generations")), Integer.parseInt(parameters.get("world")), Integer.parseInt(parameters.get("scenario")));
    }
